...
Research paper reference: [Clinical trial on tonal tinnitus with tailor-made notched music training](https://link.springer.com/content/pdf/10.1186/s12883-016-0558-7.pdf)
...
- Install BlackHole virtual device for audio loopback (separate download):
  - Download BlackHole (2 channels version) from [existential.audio](https://existential.audio/blackhole/)
